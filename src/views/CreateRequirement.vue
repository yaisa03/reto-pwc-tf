<template>
  <div class='container  row g-0 align-items-center'>
    <form class='row g-30 '>
      <div class='Back'>
      <p>
        <button class = 'arrow'><img class="rounded-circle" src='../assets/FlechaIzq.png' alt='Logo' /></button>
      ...
      <div class="row g-1 align-items-center ">
        ...
        <div class="col-sm-5 ">
          ...
          <button class='arrowRight'><img height='33' class="rounded-circle" src='../assets/flechaRicht.png' alt='Logo' /></button>
           </div >
        </div>
